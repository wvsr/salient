      ...
      <BS.Container>
        <Container className='form' sx={{ pt: 15, pb: 10 }}>
          <BS.Row>
            ...
            <BS.Col>
              <BS.Row>
                <Box component={'div'} sx={{ mt: 10, pb: 0 }}>
                  <h4 className='font'>
                    As we build out functionality of the site we would love any
                    feedback
                  </h4>
                  <h4 className='font'>Any suggestions?</h4>
                  <h4 className='fontbold'>Email us at bg2767@columbia.edu</h4>
                </Box>
              </BS.Row>
              {/* <BS.Row> */}
